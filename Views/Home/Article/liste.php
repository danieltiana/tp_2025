<?php foreach ($articles as $a): ?>
    <div class="row">
        ...
        <div class="col-md-8 right-column order-1 ">
            ...
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ullam aspernatur repellat voluptatum eos voluptas iure
            animi aliquam id eius ipsam esse doloribus quisquam unde, sunt nulla sapiente reprehenderit molestiae
            blanditiis! ....
            <div class="card-footer extrait mt-2">
                <img src="/images/img (2).jpg" class="img-thumbnail img-small" alt="">
            </div>
        </div>
    ...
    <div class="row mt-3">
        ...
        <div class="col-md-8 right-column order-1 ">
            ...
            blanditiis! ....
            <div class="card-footer extrait mt-2">
                <img src="/images/img (3).jpg" class="img-thumbnail img-small" alt="">
            </div>
        </div>
